...
function MCS() {
    ...
    */
    this.registerDeviceToken = function registerDeviceToken(options, callback) {
        ...
        Notications.registerForPushNotications(
            function(e) {
                
                self._deviceToken = e.token;
                
                var noticationProvider = (System.OS == 'iOS') ? 'APNS' : 'GCM';
                ...
                var body = '{' +
                    '"noticationToken": ' + self._deviceToken + ',' +
                    '"noticationProvider": ' + noticationProvider + ',' +
                    '"mobileClient": {' +
                    '"id": ' + packageName + ',' +
                    '"version": '+version+',' +
    ...
    * @params {string} options.sessionId - Seesion ID
